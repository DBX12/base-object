...
trait ReflectionHelpers
{
     ...
     */
    public function invokeMethod($objectOrClassFqn, string $method, $args = [], $revoke = true)
    {
     ...
     * @throws \ReflectionException
     */
    public function getInaccessibleProperty($objectOrClassFqn, $propertyName, $revoke = true)
    {
        $info       = $this->processObjectOrClassFqn($objectOrClassFqn);
        $reflection = $info['reflection'];
        $object     = $info['object'];
